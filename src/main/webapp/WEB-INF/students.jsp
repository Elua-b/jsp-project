    ...
    <c:if test="${authenticatedUser !=null}">
        <div class="w-full flex justify-between items-center">
            ...
            <button
                    ...
                    aria-label="login "
                    class="focus:ring-2 w-32 flex items-center justify-center focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-green-300 border rounded hover:bg-green-300 duration-1000 hover:animate-ring py-4 disabled:bg-slate-600"
                    type="submit"
            >
        ...
        <form action="all-students?page=statusapproval" method="post" class="form-group">
            ...
            <table class="table table-bordered">
                <thead>
                <tr class="bg-green-300 text-white font-bold">
