...
<div class="absolute  top-0 left-0 right-0 w-full bg-white flex items-center justify-between px-24 py-3">
    ...
    <div class=" flex items-center">
        <a href="login?page=login" class="mx-2">
            <button class="border-green-300 rounded-xl border-2 px-3 py-4 cursor-pointer font-semibold text-green-300">
                Login
            </button>
        </a>
        <a href="register?page=createuser" class="mx-2">
            <button class="border-green-300 rounded-xl border-2 bg-green-300 text-white font-semibold px-4 py-2 cursor-pointer">
                Register
            </button>
        </a>
    </div>
