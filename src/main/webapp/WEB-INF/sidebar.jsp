    ...
    <div class="flex my-4 flex-col">
        <div class="my-4 flex flex-col">
            ...
            <div class="pl-3 flex flex-col">
                <a class="my-2 text-white w-7/12 font-bold cursor-pointer bg-green-300 rounded-lg px-4 py-1"
        ...
        <div class="my-4 flex flex-col">
            ...
            <div class="pl-3 flex flex-col">
                ...
                <a class="my-2 text-white w-7/12 font-bold cursor-pointer bg-grenn-300 rounded-lg px-4 py-1"
            ...
            <div class="flex flex-col w-full items-center mt-10">
                <div class="flex w-7/12 flex-col items-center mt-10">
                    <a href="all-users?page=profile&&id=${authenticatedUser.id}">
                        <button class="bg-green-300 hover:bg-green-300 text-white font-bold py-2 px-4 rounded">Profile
                        </button>
                    </a>
                    <a href="login?logout=logout">
                        <button class="bg-green-300 hover:bg-green-300 text-white font-bold py-2 px-4 rounded">Logout
                        </button>
                    </a>
                </div>
            </div>
