    ...
    <form class="w-8/12 flex flex-col" action="new-mark?page=createmark" method="post">
        ...
        <div class="mt-8">
            <button
                    name="saveStd"
                    role="button"
                    class="focus:ring-2 w-44 flex items-center justify-center focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-green-300 border rounded hover:bg-green-300 duration-1000 hover:animate-ring py-4 w-full disabled:bg-slate-600"
                    type="submit"
            >
                Register
            </button>
        </div>
        <a href="all-marks?page=marks&&action=list" class="my-6 text-green-300">View all marks </a>
    </form>
</div>
</body>
