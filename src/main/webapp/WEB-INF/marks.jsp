    ...
    <c:if test="${authenticatedUser !=null}">
        <div class="w-full flex items-center justify-between">
            <a href="new-mark?page=createmark">
                <button
                        class="focus:ring-2 w-44 flex items-center justify-center focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-green-200 border rounded hover:bg-green-300 duration-1000 hover:animate-ring py-4 w-full disabled:bg-slate-600"
                >
                    Add marks
                </button>
            </a>
